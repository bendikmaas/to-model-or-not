...
if __name__ == '__main__':
    ...
    parser.add_argument('--revisit_policy_search_rate', type=float, default=0.66,
    ...
    for do_consistency, do_reconstruction in [(True, False)]:
        if args.opr == "train":
        ...
        game_config.do_consistency = do_consistency
        game_config.do_reconstruction = do_reconstruction
