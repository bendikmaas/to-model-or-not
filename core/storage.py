...
class SharedStorage(object):
    ...
    def set_data_worker_logs(self, eps_len, eps_len_max, eps_ori_reward, eps_reward, eps_norm_return,
        ...
        self.norm_return_log.append(eps_norm_return)
    ...
    def get_worker_logs(self):
        if len(self.reward_log) > 0:
            ...
            norm_return = sum(self.norm_return_log) / len(self.norm_return_log)
        ...
        return (ori_reward, reward, norm_return, reward_max, eps_lengths, eps_lengths_max,
                test_counter, test_dict, temperature, visit_entropy, priority_self_play, distributions)
